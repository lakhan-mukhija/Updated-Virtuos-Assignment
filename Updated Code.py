    ...
    while True:
        ...
        if Round1Marks < 0 or Round1Marks > 10:
            while True:
                ...
                Round1Marks = float(input("Enter Round 1 marks (between 0 to 10): ").strip())
                if Round1Marks>0 and Round1Marks<10:
                    break
        ...
        Criteria=70/100
        Round1criteria=10*Criteria
        Round2criteria=10*Criteria
        Round3criteria=10*Criteria
        TechnicalRoundcriteria=20*Criteria

        if TotalMarks>=35 and Round1Marks>=Round1criteria and Round2Marks>=Round2criteria and Round3Marks>=Round3criteria and TechnicalRoundMarks>=TechnicalRoundcriteria :
            Result="Selected"
        else:
            Result="Rejected"
